const CACHE_SITE_SIGN_IN = 'site-sign-in-cache-v44';
const CACHE_DEER_CULL = 'deer-cull-cache-v44';
const CACHE_OBSERVATIONS = 'observations-cache-v4';
const GENERAL_CACHE = 'general-cache-v44';
